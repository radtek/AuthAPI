...
public class GetAccountInfoServiceImpl implements GetAccountInfoService {
    ...
    public GetAccountInfoServiceImpl(RpAccountsTableHelper rpAccountsTableHelper, RelyPartsTableHelper relyPartsTableHelper, AuthenticationHelper authenticationHelper, AccountInfoResponse accountInfoResponse, SystemErrorResponse systemErrorResponse, RelyPartHelper relyPartHelper) {
    ...
    @Override
    public AuthAPIResponse getAccountInfo(String appUuid, String token, String accountUuid) {
        //检查参数
