...
public class XL_CertAPI {
    ...
    public @ResponseBody
    AuthAPIResponse requestCloudCert(@ModelAttribute RequestCloudCertRequest requestCloudCertRequest, BindingResult bindingResult) {
     ...
     *
     * @param downloadCertRequest
     *      user_id=<user_id>&verify_token=<verify_token>&app_id=<app_id>
     * @param bindingResult  数据绑定结果
     * @return
     * 			{
     * 				error_code: error_code,
